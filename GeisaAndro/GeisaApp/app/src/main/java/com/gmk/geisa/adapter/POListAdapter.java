 ...
 */
public class POListAdapter extends RecyclerView.Adapter<POListAdapter.ItemViewHolder> {
    ...
    public POListAdapter(List<mPO> po, Context context, mSession session,boolean isConfirm,boolean isCPP) {
        mPO = po;
       // Log.e("ada po","ttl"+po.size());
        mContext = context;
    ...
    public void onBindViewHolder(final ItemViewHolder holder, int position) {
        ...
        //Log.e("cek PP",selectedCustomer.isPP()+","+selectedCustomer.getPoId());
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                inten.putExtra(PoNewActivity.sessionCustomer,String.valueOf(selectedCustomer.getCustId()));
    ...
    public static class UserFilter extends Filter {
        ...
        private final POListAdapter adapter;

        private final List<mPO> originalList;

        private final List<mPO> filteredList;

        private UserFilter(POListAdapter adapter, List<mPO> originalList) {
            super();
