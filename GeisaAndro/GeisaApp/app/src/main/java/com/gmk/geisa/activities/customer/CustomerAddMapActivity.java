...
public class CustomerAddMapActivity extends AppCompatActivity {// implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
   ...
   // private LatLng myPosition;
    ...
    //for maps
    // LogCat tag
    private static final String TAG = CustomerAddMapActivity.class.getSimpleName();
