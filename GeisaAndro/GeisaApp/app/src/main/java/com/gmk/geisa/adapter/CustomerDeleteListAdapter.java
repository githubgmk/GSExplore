 ...
 */
public class CustomerDeleteListAdapter extends RecyclerView.Adapter<CustomerDeleteListAdapter.ItemViewHolder> {
    ...
    public CustomerDeleteListAdapter(List<mCustomer> customers, Context context, TextView tv) {
    ...
    public static class UserFilter extends Filter {
        ...
        private final CustomerDeleteListAdapter adapter;

        private final List<mCustomer> originalList;

        private final List<mCustomer> filteredList;

        private UserFilter(CustomerDeleteListAdapter adapter, List<mCustomer> originalList) {
            super();
