...
import com.gmk.geisa.adapter.CallPlanNoteAdapter;
...
public class ReportBIActivity extends AppCompatActivity implements com.kenmeidearu.materialdatetimepicker.date.DatePickerDialog.OnDateSetListener {
    ...
    private CallPlanNoteAdapter adapter1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("All Report BIN");

        callPlanController = CallPlanController.getInstance(this);
        callPlanController.setCallBackGetDataAllCallNoteUpdate(callBackCall);
    ...
    CallPlanController.CallBackGetDataAllCallNoteUpdate callBackCall = new CallPlanController.CallBackGetDataAllCallNoteUpdate() {
        @Override
        public void resultReady(ArrayList<mCallPlanNote> call, boolean hasil) {
            //if (hasil) {
    ...
    private void getDataPOBetweenServer(String from, String to) {
        ...
        if (null != session) {
            callPlanController.checkNewUpdateBetweenAllCallPlanNoteFromServer(String.valueOf(SalesId), dateFrom.getEditableText().toString(), dateTo.getEditableText().toString(),custId);
        } else {
    ...
    private void getDataPOBetweenLokal(String salesId, String from, String to) {
        //
        ArrayList<mCallPlanNote> po = callPlanController.getAllBIBetween(salesId, from, to,custId);
        Log.e("bin", salesId + "," + from + "," + to+","+po.size());
        setupRecyclerView(po);
    }


    private void setupRecyclerView(ArrayList<mCallPlanNote> po) {

        recyclerView.setHasFixedSize(true);
        recyclerView.setNestedScrollingEnabled(false);
        mLayoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(mLayoutManager);
        adapter1 = new CallPlanNoteAdapter(po, this, session);
