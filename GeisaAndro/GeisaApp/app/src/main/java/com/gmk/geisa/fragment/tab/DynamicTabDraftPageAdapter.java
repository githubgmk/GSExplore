...
public class DynamicTabDraftPageAdapter extends FragmentStatePagerAdapter
        implements PagerSlidingTabStrip.CustomTabProvider {
    Context context;
    ArrayList<ViewPagerTab> tabs;
    ArrayList<CallPlanDraftTabViewFragment> fragments;


    public DynamicTabDraftPageAdapter(FragmentManager fm, ArrayList<ViewPagerTab> tabs, ArrayList<CallPlanDraftTabViewFragment> fragments) {
        super(fm);
        this.tabs = tabs;
