...
/**
 * Created by kenjinsan on 7/22/17.
 */
...
public class LocationAssistant implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    public interface Listener {
         ...
         */
        void onMockLocationsDetected(View.OnClickListener fromView, DialogInterface.OnClickListener fromDialog,String mockApp,boolean mockLocationsEnabled);
    ...
    private void checkMockLocations() {
        ...
        if (Build.VERSION.SDK_INT < 18 &&
            ...
            if (listener != null)
                listener.onMockLocationsDetected(onGoToDevSettingsFromView, onGoToDevSettingsFromDialog,mockAppName,mockLocationsEnabled);
        } else {
    ...
    public boolean isMockLocationEnabled() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            List<ActivityManager.RunningAppProcessInfo> processes = AndroidProcesses.getRunningAppProcessInfo(context.getApplicationContext());
                            ...
                            if (requestedPermissions[i].equals("android.permission.ACCESS_MOCK_LOCATION")
                                ...
                                for (String p : proses) {
                                    if (p.equalsIgnoreCase(applicationInfo.packageName)) {
                                        ...
                                        mockAppName=applicationInfo.packageName;
                                        return true;
                                    }
            ...
            isMock = !android.provider.Settings.Secure.getString(context.getContentResolver(), "mock_location").equals("0");
        }
        return isMock;
    }
        ...
        public void onClick(DialogInterface dialog, int which) {
            if (activity != null) {
               ...
               // Intent intent=new Intent(android.provider.Settings.ACTION_APPLICATION_SETTINGS);
                ...
                i.setData(Uri.parse("package:"+mockAppName));
    ...
    private boolean isLocationPlausible(Location location) {
        ...
        //boolean isMockLocation = extras != null && extras.getBoolean(FusedLocationProviderApi.KEY_MOCK_LOCATION, true);
        boolean isMock = mockLocationsEnabled || (Build.VERSION.SDK_INT >= 18 && location.isFromMockProvider());
        //Log.e("isi mock",Build.VERSION.SDK_INT+" mock "+isMock+" mock "+(Build.VERSION.SDK_INT >= 18 && location.isFromMockProvider())+", "+isMockLocation);
        if (isMock) {
        ...
        // Log.e("isi mock b",Build.VERSION.SDK_INT+" mock "+isMock+","+numGoodReadings);
        ...
        // Log.e("isi mock c",Build.VERSION.SDK_INT+" mock "+isMock+","+d);
        return (d > 1000);
    }
    ...
    public void onLocationChanged(Location location) {
        ...
        if (!allowMockLocations && !plausible) {
            if (listener != null) listener.onMockLocationsDetected(onGoToDevSettingsFromView, onGoToDevSettingsFromDialog,mockAppName,mockLocationsEnabled);
            return;
        }
