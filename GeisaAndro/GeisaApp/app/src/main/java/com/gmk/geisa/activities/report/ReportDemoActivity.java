...
import com.gmk.geisa.adapter.CallPlanComplainAdapter;
import com.gmk.geisa.adapter.CallPlanDemoAdapter;
...
public class ReportDemoActivity extends AppCompatActivity implements com.kenmeidearu.materialdatetimepicker.date.DatePickerDialog.OnDateSetListener {
    ...
    private CallPlanDemoAdapter adapter1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("All Report Demo");

        callPlanController = CallPlanController.getInstance(this);
        callPlanController.setCallBackDemo(callBackCall);
    ...
    CallPlanController.CallBackDemo callBackCall = new CallPlanController.CallBackDemo() {
        @Override
        public void resultReady(ArrayList<mDemo> complain, boolean hasil) {
            //if (hasil) {
    ...
    private void getDataPOBetweenServer(String from, String to) {
        ...
        pDialog.setMessage("Check Update Demo From Server ...\n Please Wait...");
        pDialog.show();

        if (null != session) {
            callPlanController.checkNewUpdateBetweenAllDemoFromServer(String.valueOf(SalesId), dateFrom.getEditableText().toString(), dateTo.getEditableText().toString(),custId);
        } else {
    ...
    private void getDataPOBetweenLokal(String salesId, String from, String to) {
       // Log.e("bin",salesId+","+from+","+to);
        ArrayList<mDemo> po = callPlanController.getAllCallPlanDemoBetween(salesId, from, to,custId);
        setupRecyclerView(po);
    }


    private void setupRecyclerView(ArrayList<mDemo> po) {

        recyclerView.setHasFixedSize(true);
        recyclerView.setNestedScrollingEnabled(false);
        mLayoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(mLayoutManager);
        //Log.e("masuk sini ada complain"," ada"+ po.size());
        adapter1 = new CallPlanDemoAdapter(po, this, session);
