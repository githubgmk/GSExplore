 ...
 */
public class POListRefAdapter extends RecyclerView.Adapter<POListRefAdapter.ItemViewHolder> {
    ...
    public POListRefAdapter(List<mPO> po, Context context, mSession session, boolean isConfirm, boolean isCPP) {
        mPO = po;
        mContext = context;
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View rowView = LayoutInflater.from(parent.getContext()).inflate(R.layout.checked_po_list, parent, false);
    ...
    public void onBindViewHolder(final ItemViewHolder holder, int position) {
        ...
        if (selectedCustomer.getPoId().equalsIgnoreCase(poIdSelected)) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                poIdSelected = selectedCustomer.getPoId();
                notifyItemRangeChanged(0, filteredUserList.size());
    ...
    public static class ItemViewHolder extends RecyclerView.ViewHolder implements
        ...
        public final TextView custid, custname, custAddress, distributor, distributorAddress, custcode, pricecode, tglcreate, status;
    ...
    public static class UserFilter extends Filter {
        ...
        private final POListRefAdapter adapter;

        private final List<mPO> originalList;

        private final List<mPO> filteredList;

        private UserFilter(POListRefAdapter adapter, List<mPO> originalList) {
            super();
